            ...
            postCreate: function () {
                ...
                */
                ...
                if (!this.layerInfos) {
                    ...
                    */
                    var layerArray = ["MD.State.ZCTA_ACS_897", "MD.State.ZCTA_ACS_2107", "MD.State.ZCTA_ACS_267", "MD.State.ZCTA_ACS_4579", "MD.State.ZCTA_ACS_6772", "MD.State.ZCTA_ACS_5026", "MD.State.ZCTA_ACS_8015", "MD.State.ZCTA_ACS_7042", "MD.State.ZCTA_ACS_9044", "MD.State.ZCTA_ACS_4064", "MD.State.ZCTA_ACS_451", "MD.State.ZCTA_ACS_9573", "MD.State.ZCTA_ACS_395", "MD.State.ZCTA_ACS_4154", "MD.State.ZCTA_ACS_8485", "MD.State.ZCTA_ACS_2438", "MD.State.ZCTA_ACS_2894", "MD.State.ZCTA_ACS_8470", "MD.State.6InchImagery_6552"];
                    for (var i = 0; i < layerArray.length; i++){
                        var rootLayer = this.map.getLayer(layerArray[i]);
