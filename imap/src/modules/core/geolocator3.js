    ...
    function(declare, on, lang, Geocoder, Popup){
        return declare([], {
            ...
            , constructor: function(args) {
                ...
                geocoder.startup();
                this._symbol = new esri.symbol.PictureMarkerSymbol({"angle":0,"xoffset":12,"yoffset":12,"type":"esriPMS","url":"http://static.arcgis.com/images/Symbols/Basic/YellowFlag.png","contentType":"image/png","width":24,"height":24})
