        ...
        return declare([Evented], {
            configure: function () {
                ...
                var configOptions = {
					...
					webmap: "40d8b55694b94f86aedaccfeef61c868",      //"blank" map
                    ...
                    description: "<h2><b>MDP Land Use/Land Cover</b></h2>\
					<p style='font-size:13px'>The Land Use & Cover map and data is used to show development trends on the landscape in Maryland. \
					Mapping these changes is a key informational tool in addressing future smart growth issues in the State.\
					<br><br>MDP is a comprehensive source for maps of current Land Use/Land Cover for every jurisdiction in Maryland. The Land Use/Land Cover Interactive Map will allow you to view, zoom and pan our digital map layers.\
					<br><br>To familiarize yourself with the 2010 Land Use/Land Cover release, please refer to these materials:</p>\
					<ul>\
					<li style='font-size:13px'><a href='http://planning.maryland.gov/PDF/OurWork/LandUse/MDP2010_LU_Summary.pdf' target='_blank'>Summary - MDP 2010 Land Use</a></li>\
					<li style='font-size:13px'><a href='http://planning.maryland.gov/PDF/OurWork/LandUse/Methodology_MappingProcess.pdf' target='_blank'>Mapping Process and Methodology</a></li>\
					<li style='font-size:13px'><a href='http://planning.maryland.gov/PDF/OurWork/LandUse/AppendixA_LandUseCategories.pdf' target='_blank'>Land Use/Land Cover Classification Definitions</a></li>\
					<li style='font-size:13px'><a href='http://planning.maryland.gov/PDF/OurWork/LandUse/metadata.pdf' target='_blank'>Metadata</a></li>\
					</ul>\
					<p style='font-size:13px'><b>How to Use Map</b>           \
					<br>Under the Legend Tab, press the the four different panels to view the four different land use / land cover maps available.    \
					<br><br>Click on the map to display a pop up that shows additional land use / land cover data for each county, including charts and PDFs. \
					<br><br>Use the draw and measure tool to mark up the map with points, lines, polygons, or measurements.\
					<br><br>Use the drop down to zoom to your county of interest or type in an address in the search bar.\
					<br><br>Change the basemap to see underlying imagery or reference street map.<br>    \
					<br><br><b><p style='font-size:13px'>Have questions about this interactive map?</b><br>Email<a href='mailto:DLMDP-GIS_MDP@maryland.gov?subject=MDP Land Use / Land Cover Map'>DLMDP-GIS_MDP@maryland.gov</a> <br><br><a href='http://planning.maryland.gov/OurWork/landuse.shtml' target='_blank'><b>MDP Land Use/Land Cover Home Page<b/></a></p>\
					<br><center><a href='http://planning.maryland.gov/OurWork/landuse.shtml' target='_blank'><img src='http://planning.maryland.gov/images/icons/iMap/landuse.jpg'></a></center>",
		    ...
		    dynTheme: "dynMain",
                    ...
                    title: "MDP Land Use / Land Cover Interactive Map",
                    ...
                    customlogo: {
                        image: 'http://planning.maryland.gov/images/homepage/agencyLogo-Planning.png',
                        link: 'http://planning.maryland.gov'
                    },
		    ...
		    if (urlObject.query.dynTheme) {
                        configOptions.dynTheme = urlObject.query.dynTheme;
                    }
                }
